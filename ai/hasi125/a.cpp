...
int main() {
	...
	set<int> used = {18,16,15,10,9,11,12,6,3,1,4,0,2,5,7,8,13,17,14,20,25,19,24,40,45,27,23,35,28,42,72,77,95,105,153,139,132,99,116,142,163,154,157,56,78,87,107,113,108,89,94,64,63,50,37,30,34,46,178,176,187,194,186,195,198,200,201,199,57,81,60,44,55,48,68,85,52,32,197,196,191,173,148,138,162,127,110};
	const int TH = 6;
	for (int i = 0; i < 2*N; ++ i) {
	...
	{
		vector<int> a {18,16,15,10,9,11,12,6,3,1,4,0,2,5,7,8,13,17,14,20,25,19,24,40,45};
		for (int i = 0; i < (int)a.size(); ++ i) {
			res[a[i]] = H[(i+109-a.size()+2)%H.size()];
		}
	}
	{
		vector<int> a {27,23,35,28,42,72,77,95,105,153,139,132,99,116,142,163,154,157};
		for (int i = 0; i < (int)a.size(); ++ i) {
			res[a[i]] = H[(i+40-a.size()+2)%H.size()];
		}
	}
	{
		vector<int> a {56,78,87,107,113,108,89,94,64,63,50,37,30,34,46};
		for (int i = 0; i < (int)a.size(); ++ i) {
			res[a[i]] = H[(i+79-a.size()+2)%H.size()];
		}
	}
	{
		vector<int> a {178,176,187,194,186,195,198,200,201,199};
		for (int i = 0; i < (int)a.size(); ++ i) {
			res[a[i]] = H[(i+51-a.size()+2)%H.size()];
		}
	}
	{
		vector<int> a {57,81,60,44,55,48,68,85,52,32};
		for (int i = 0; i < (int)a.size(); ++ i) {
			res[a[i]] = H[(i+22-a.size()+2)%H.size()];
		}
	}
	{
		vector<int> a {197,196,191,173,148,138,162,127,110};
		for (int i = 0; i < (int)a.size(); ++ i) {
			res[a[i]] = H[(i+64-a.size()+2)%H.size()];
		}
	}
