...
int main() {
	...
	set<int> used = {39,40,51,52,70,57,46,62,55,67,89,81,93,114,109,88,103,121,135,122,101,85,68,87,131,118,133,134,117,98,113,132,136,120,107};
	const int TH = 6;
	for (int i = 0; i < 2*N; ++ i) {
	...
	{
		vector<int> a {39,40,51,52,70,57,46,62,55,67,89,81,93,114,109,88,103,121,135,122,101,85,68,87};
		for (int i = 0; i < (int)a.size(); ++ i) {
			res[a[i]] = H[(i+41-a.size()+2)%H.size()];
		}
	}
	{
		vector<int> a {131,118,133,134,117,98,113,132,136,120,107};
		for (int i = 0; i < (int)a.size(); ++ i) {
			res[a[i]] = H[(i+55-a.size()+2)%H.size()];
		}
	}
	{
		vector<int> a {31,20,11,7,3,9};
		for (int i = 0; i < (int)a.size(); ++ i) {
			res[a[i]] = H[(i+7-a.size()+2)%H.size()];
		}
	}
	{
		vector<int> a {1,5,14,23,16,6};
		for (int i = 0; i < (int)a.size(); ++ i) {
			res[a[i]] = H[(i+74-a.size()+2)%H.size()];
		}
	}
