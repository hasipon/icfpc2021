...
int main() {
	...
	set<int> used = {58,70,76,82,67,54,47,60,71,78,86,90,93,98,97,89,88,92,96,91,85,94,95,87,81,66,74,79,14,9,4,2,7,5,1,0,3,6,57,44,37,31,33,23,22};
	const int TH = 7;
	for (int i = 0; i < 2*N; ++ i) {
	...
	{
		vector<int> a {58,70,76,82,67,54,47,60,71,78,86,90,93,98,97,89,88,92,96,91,85,94,95,87,81,66,74,79};
		for (int i = 0; i < (int)a.size(); ++ i) {
			res[a[i]] = H[(i+37-a.size()+2)%H.size()];
		}
	}
	{
		vector<int> a {14,9,4,2,7,5,1,0,3,6};
		for (int i = 0; i < (int)a.size(); ++ i) {
			res[a[i]] = H[(i+56-a.size()+2)%H.size()];
		}
	}
	{
		vector<int> a {57,44,37,31,33,23,22};
		for (int i = 0; i < (int)a.size(); ++ i) {
			res[a[i]] = H[(i+45-a.size()+2)%H.size()];
		}
	}
